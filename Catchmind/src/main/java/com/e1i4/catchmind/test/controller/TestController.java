	...
	public String mbtiResult(String mbtiResult, HttpSession session) {
		...
		if(mbtiResult.equals("ESTP")) {
			...
			testResult = new Test("./resources/images/mbtiResult/ESTP_ResultImg.png", 
						 		  "모험을 즐기는 사업가", 
						 		  "ESTP",
					     "인생이 즐겁고 놀라움으로 가득 차 있으며 지금 이 순간 모든 것을 즐기는 당신! '언젠가'를 위한 계획을 세우는데 많은 시간을 투자하지는 않지만, 당신의 열정과 예측 불가능성은 당신을 짜릿한 데이트 상대로 만들어줄 것입니다. " +
						 "하지만 시간이 지남에 따라, 관계를 더 깊고 감정적으로 친밀한 수준으로 옮기는 것이 어려울 수 있습니다. 쉽게 지루해하는 사업가적 성격을 가진 당신은 지속적인 자극을 추구합니다. 때로는 의도적으로 자신을 자극에 노출시키기도 합니다.", "");
			...
			testResult = new Test("./resources/images/mbtiResult/ESTJ_ResultImg.png", 
						 		  "엄격한 관리자", 
						 		  "ESTJ", 
					     "정직함과 솔직함을 매우 중요시하는 당신! 처음부터 자신이 누구인지, 자신이 어떤 사람인지, 그리고 목표가 무엇인지에 대해 분명하기 때문에 당신의 연인이 당신의 말을 믿고 따를 수 있는 한, 당신과 연인은 매우 안정적인 관계일 수밖에 없습니다. " +
						 "하지만 자신의 옳음을 확고히 믿고 고집이 센 당신은 연인의 연약한 감정을 빠르게 손상시킬 수 있습니다. 이를 염두에 두고, 강력한 성격의 균형을 맞추고 성장의 기회를 제공하기 위해 한두 가지 상반되는 특성을 가진 연인을 찾는 것이 좋습니다.", "");
			...
			testResult = new Test("./resources/images/mbtiResult/ESFP_ResultImg.png", 
						 		  "자유로운 영혼의 연예인", 
						 		  "ESFP", 
					     "재미를 사랑하고, 자유분방하며, 그 순간순간의 삶을 살아가는 당신! 당신은 데이트를 할 때 이러한 신선함과 에너지를 아끼지 않습니다. 당신의 사랑은 불꽃같지만 즐거움이 사라지면 불꽃 또한 사라집니다. " +
						 "만약 일주일 후 당신이 똑같이 느끼지 않는다면, 그것은 그뿐이고, 당신은 관계를 끊는 것을 심각하게 고려하지 않습니다. " + 
			...
			testResult = new Test("./resources/images/mbtiResult/ESFJ_ResultImg.png", 
								  "사교적인 외교관", 
								  "ESFJ", 
					     "따뜻한 신뢰와 가치를 느끼고 싶어 하는 당신! 이해를 쌓는 것부터 서로의 의견과 목표에 대한 상호 존중과 지지를 쌓는 것까지 애인과의 상호 충족을 위해 노력하는 당신은 연인이 사랑받고 인정받고 있다는 것을 " + 
					     "아는 것이 당신의 기분과 자존심에 큰 영향을 미칩니다. 당신은 갈등과 비판을 싫어하는데, 이것은 어떤 문제가 생겨도 해결하는 것을 어렵게 만들 수 있습니다. 당신은 연인이 당신의 꿈이나 의견을 존중하지 않는다는 것을 " + 
			...
			testResult = new Test("./resources/images/mbtiResult/ENFP_ResultImg.png", 
								  "재기발랄한 활동가", 
								  "ENFP", 
					     "희망과 꿈, 아이디어와 경험으로 가득 찬 열정적이고 따뜻하며 개방적인 당신! 당신은 연인과의 관계에서 이 활기찬 에너지를 모두 가져다줍니다. 당신은 누군가에게 관심을 가질 때, 주저하지 않습니다. " +  
						 "쉽게 사랑에 빠지는 경향이 있고, 심하게 빠집니다. 자신의 삶을 다른 사람과 공유하고 싶은 깊은 갈망을 가지고 있는 당신은 독신일 때 약간 공허하거나 영감을 받지 못한다고 느낄 수 있습니다. " +
			...
			testResult = new Test("./resources/images/mbtiResult/ENFJ_ResultImg.png", 
						 		  "정의로운 사회운동가", 
						 		  "ENFJ", 
						 "자신의 이상에 미치지 못하는 것에 만족하는 경우가 거의 없는 당신! 연애도 예외는 아닙니다. 누군가에게 빠져들면, 심하게 넘어지는 경향이 있습니다. 그리고 그것에 대해 수줍어하지 않습니다. " + 
						 "자신이 느끼는 감정을 가장 쉽게 표현하는 성격 유형들 중 하나이기 때문에 상대방이 같은 감정을 느낄 때까지 기다리기보다는, 본인이 먼저 행동하는 것을 발견할 수 있습니다. " + 
						 "당신의 인생에서 가장 큰 즐거움 중 하나는 자신이 아끼는 누군가가 그들의 목표에 도달하도록 돕는 것입니다. 연인의 목표를 자신의 것으로 받아들이면서 이것을 한 단계 더 발전시킵니다. " +
			...
			testResult = new Test("./resources/images/mbtiResult/ENTP_ResultImg.png", 
								  "뜨거운 논쟁을 즐기는 변론가", 
								  "ENTP", 
				         "일을 계속 진행시키기 위한 끝없는 혁신과 아이디어의 흐름을 생각해 내는 당신! 당신의 성격 유형의 핵심은 성장이고, 심지어 연인을 찾기도 전에, 함께 새로운 것을 경험할 수 있는 모든 방법을 상상합니다. " +
						 "당신과 데이트하는 것은 거의 지루한 경험이 아니며, 자신의 새로운 아이디어와 경험으로 연인을 기쁘게 하고 놀라게 함으로써 자신의 열정과 창의력을 활용합니다. 당신의 열정은 매력적일 수 있지만, " + 
				         "가장 인내심이 많은 연인도 지치게 할 수 있습니다. 잠시 숨을 쉴 수 있는 시간은 많은 사람들에게 필요하지만, 당신에게는 그것이 높이 평가할 만한 것은 아닙니다. " + 
			...
			testResult = new Test("./resources/images/mbtiResult/ENTJ_ResultImg.png", 
						 		  "대담한 통솔자", 
						 		  "ENTJ", 
						 "일련의 목표와 그것들을 성취하기 위한 계획을 가지고 있는 당신! 삶의 다른 분야와 마찬가지로, 데이트와 관계에 접근할 때도 계획을 가지고, 인상적인 에너지와 열정을 가지고 진행합니다. " + 
			...
			testResult = new Test("./resources/images/mbtiResult/ISTJ_ResultImg.png", 
								  "청렴결백한 논리주의자", 
								  "ISTJ", 
					     "철저하게 신뢰할 수 있는 당신! 이 특성은 연인 관계에서도 분명히 나타납니다. 가족 가치의 대명사를 나타내며, 전통적인 가정과 명확하고 정직한 가족 구성원을 추구합니다. 내성적인 성격이 종종 데이트를 어렵게 만들지만, " + 
						 "안정적이고 상호 만족스러운 관계를 보장하기 위해 엄청난 생각과 에너지를 기꺼이 쏟는 헌신적인 애인입니다. 소개팅은 당신이 연인을 찾기 위해 선호하는 방법이 아닙니다. 당신은 관심 있는 동료와의 저녁 식사나, " + 
			...
			testResult = new Test("./resources/images/mbtiResult/ISTP_ResultImg.png", 
								  "만능 재주꾼", 
								  "ISTP", 
					     "새로운 활동과 경험을 추구하며 현재를 살고 있는 당신! 당신과의 데이트는 냉담함과 초연함, 열정, 자발성, 그리고 순간의 즐거움을 번갈아 가며 하는 복잡하고 흥미로운 탱고입니다. " + 
						 "당신과의 관계에서는 어떤 것도 강요할 수 없지만, 자기 자신이 되기 위해 필요한 공간이 주어진다면, 당신은 평생 동안 안정된 연인과의 편안함을 기꺼이 누릴 것입니다. 연애 초기에, " + 
					     "당신은 특히 변덕스러울 수 있습니다. 육체적으로나 정신적으로나 많은 개인적인 공간이 필요하며, 당신을 통제하거나 강제로 당신의 활동을 계획하려는 시도는 이탈을 가속화시킬 뿐입니다. " + 
			...
			testResult = new Test("./resources/images/mbtiResult/ISFJ_ResultImg.png", 
								  "용감한 수호자", 
								  "ISFJ", 
					     "온화하고 겸손한 외관 아래 사랑하는 사람들에 대한 열정적인 헌신과 충성심을 가지고 있는 당신! 때때로 자기 자신의 강렬함, 특히 연인을 보호하고 돌보려는 자신의 격렬한 열망에 놀랄 수 있습니다. " + 
						 "감정이 매우 깊은 당신은 당신의 연인이 자신에게 얼마나 중요한지를 표현하기 위한 단어를 찾는데 어려움을 겪을 수 있습니다. 하지만 당신은 매일 백만 가지의 작은 방법으로 연인에게 자신의 애정을 보여줍니다. " + 
			...
			testResult = new Test("./resources/images/mbtiResult/ISFP_ResultImg.png", 
								  "호기심 많은 예술가", 
								  "ISFP", 
					     "따뜻하고 열정적인 당신! 당신은 꽤 신비롭고 알아가기가 어렵습니다. 매우 감정적인 사람으로 표현하기보다 듣는 것을 선호합니다. 자기 자신의 감정으로 상황의 분위기를 지시하는 것에 거의 관심을 두지 않고 대신 자신의 연인에게 집중합니다. " + 
						 "자상하고 충성스러운 당신은 재미난 작은 방법으로 연인을 놀라게 할 수 있는 방법을 찾는 것을 좋아합니다. 연인과 시간을 보내는 것을 진심으로 즐기고, 연인이 자신의 보살핌을 받고 있고 특별하다는 것을 알기를 원합니다. " + 
			...
			testResult = new Test("./resources/images/mbtiResult/INFJ_ResultImg.png", 
								  "선의의 옹호자", 
								  "INFJ", 
					     "사람과의 관계에서 깊이와 의미를 찾는 당신! 연인과의 관계에서도 다르지 않습니다. 활기차고 생생한 상상력을 가진 것으로 알려진 성격 유형이지만, 진정한 사랑이 아닌 것에 기반을 둔 결혼에 안주하는 자신을 상상할 수는 없습니다. " + 
			...
			testResult = new Test("./resources/images/mbtiResult/INFP_ResultImg.png", 
								  "열정적인 중재자", 
								  "INFP", 
					     "로맨스에 관한 한 몽상가이자 이상주의자인 당신! 당신은 진정한 사랑의 힘과 아름다움을 믿습니다. 높은 기대를 가지고 로맨스의 세계에 접근한다고 해도 과언이 아닙니다. " + 
						 "다른 사람과 그들의 내면을 공유하는 것이 어떤 느낌일지 상상하면서, 완벽한 관계에 대한 공상에 몇 년을 보냈을지도 모릅니다. 당신은 단순히 연인을 찾는 것이 아니라, 소울메이트와 연결되기를 원합니다. " + 
			...
			testResult = new Test("./resources/images/mbtiResult/INTJ_ResultImg.png", 
						 		  "용의주도한 전략가", 
						 		  "INTJ", 
					     "사랑을 표현하는 것보다 사랑에 대해 생각하는 데 더 많은 시간을 보내는 당신! 전략적으로 명확한 목표와 목표를 달성하기 위한 계획을 가지고 대부분의 과제를 수행하는 방식으로 로맨스에 접근합니다. " + 
						 "순수하게 합리적인 세상에서, 이 접근법은 완전무결할 것입니다. 애석하게도, 사랑은 이성적인 것이 거의 없고, 당신은 인간의 본성과 애정의 예측 불가능성을 간과하거나 잘못 해석할 위험이 있습니다. " + 
			...
			testResult = new Test("./resources/images/mbtiResult/INTP_ResultImg.png", 
						 		  "논리적인 사색가", 
						 		  "INTP", 
						 "두뇌가 명석하고 내성적인 것처럼 보이는 당신! 하지만 장난스럽고 창의적인 면 또한 가지고 있습니다. 독창성을 사용하여 상황을 신선하게 유지하고 연인이 특별하다고 느끼게 하는 영리하고 예상치 못한 방법들을 생각해 낼 수 있습니다. " + 
